...
export const BUILDING_DEFINITIONS: readonly BuildingAssetDefinition[] = [
  {
    ...
    url: "/models/skyscraper.glb?v=46",
    clip: "construct",
    maxCount: 1,
    inLibrary: true,
    inPalette: true,
  ...
  },
  {
    ...
    footprint: { width: 10, depth: 10 },
    url: "/models/research-center.glb?v=1",
    clip: "construct",
    maxCount: 1,
    inLibrary: true,
    inPalette: true,
  },
  {
    ...
    footprint: { width: 10, depth: 10 },
    url: "/models/development-center.glb?v=1",
    clip: "construct",
    maxCount: 1,
    inLibrary: true,
    inPalette: true,
  },
  {
    ...
    role: "Review",
    tier: "staged",
    buildingKind: "city-building",
    stationId: "city-building",
    agentIds: ["qa-review"],
    bindMode: "agent-tasks",
    agentId: "qa-review",
    accent: "#38bdf8",
    prefix: "QA_",
    projectFile: "qa-center/qa-center.blend",
    footprint: { width: 10, depth: 10 },
    url: "/models/qa-center.glb?v=1",
    clip: "construct",
    maxCount: 1,
    inLibrary: true,
    inPalette: true,
  ...
  {
    catalogId: "deploy-pad",
    label: "Deploy Pad",
    role: "Operations",
    tier: "staged",
    buildingKind: "rocket-pad",
    stationId: "rocket-pad",
    agentIds: ["operations"],
    bindMode: "agent-tasks",
    agentId: "operations",
    accent: "#e879f9",
    prefix: "DP_",
    projectFile: "deploy-pad/deploy-pad.blend",
    footprint: { width: 10, depth: 10 },
    url: "/models/deploy-pad.glb?v=1",
    clip: "construct",
    maxCount: 1,
    inLibrary: true,
    inPalette: true,
